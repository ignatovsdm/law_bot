...
const GREETING_MESSAGE = '👋 Привет! Я юридический ассистент по российскому праву. Задай свой вопрос. Используй меню для управления диалогами или запроса консультации.'; // Обновим приветствие
...
const MAIN_MENU_NEW_DIALOGUE = '✨ Новый диалог';
const MAIN_MENU_LEAD_REQUEST = '📞 Заявка на консультацию'; // <--- НОВАЯ КНОПКА
...
const LEAD_ALREADY_SUBMITTED_IN_DIALOGUE = "Вы уже оставляли заявку в этом диалоге. Наш специалист скоро свяжется с вами. Можете задать следующий вопрос." 
const LEAD_ALREADY_IN_PROGRESS = "Вы уже находитесь в процессе оформления заявки. Пожалуйста, завершите его или начните новый диалог для отмены."; // Новое сообщение
...
const LEAD_SUBMITTED_MESSAGE = "Спасибо! Ваша заявка №%LEAD_ID% получена. Специалист свяжется с вами в ближайшее время."; 
const LEAD_CANCELLED_MESSAGE = "Понимаю. Если передумаете, вы всегда можете попросить о связи с юристом.";
const LEAD_COLLECTION_COMPLETED_NEXT_PROMPT = "Теперь вы можете задать свой следующий вопрос или начать новый диалог с помощью кнопки ниже."; 
...
module.exports = {
  ...
  NEW_DIALOGUE_FAIL,
  MAIN_MENU_NEW_DIALOGUE, // <--- НОВАЯ
  MAIN_MENU_LEAD_REQUEST, // <--- НОВАЯ
  ...
  LEAD_ALREADY_IN_PROGRESS, // <--- НОВАЯ
  ...
  LEAD_COLLECTION_COMPLETED_NEXT_PROMPT, 
